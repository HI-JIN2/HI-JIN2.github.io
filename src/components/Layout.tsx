    ...
    <div className="relative">
      <header className="fixed top-0 left-0 right-0 z-50">
        <div className="bg-[color:var(--color-bg)] border-b border-[color:var(--color-border)]">
          <div className="max-w-[900px] w-full mx-auto px-6 py-4 flex items-center justify-between gap-4">
      ...
      <main className="max-w-[800px] w-full mx-auto pt-24 px-6 pb-16 relative">
        {children}
      </main>
    </div>
  );
