    ...
    features: [
      {
        ...
        descriptions: [
          ...
          "GDSC 2024 대학 연합 해커톤 최우수상(2위) ==(200명 규모)== | GDSC 대학 연합 (2024.01)",
          "==K-PaaS 활용 디지털 사회혁신 서비스 개발 공모전 금상(2위)== (100여 팀 참가) | 한국지능정보사회진흥원 (2023.12)",
          "==AI활용 온라인 개발대회 싱커톤 시즌3 최우수상(2위)== ==(150명 규모)== | 주식회사 엔터플 (2023.11)",
          "소프트웨어 공모전 금상 | 숭실대 IT대학 (2023.08)",
          "UMC 3기 대학 연합 데모데이 대상(1위) ==(400명 규모)== | UMC 대학 연합 (2023.01)",
